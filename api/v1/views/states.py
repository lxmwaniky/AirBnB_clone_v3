#!/usr/bin/python3
"""This module creates a states view"""
...
def updates_state(state_id):
    ...
    Args:
        state_id (str): The ID of the state object to be updated.

    Returns:
        tuple: A tuple containing the updated state object
        and the HTTP status code.

    Raises:
        404: If the state object with the given ID does not exist.
